        ...
        <div class="predefined_styles">
          <div class="swichermainleft text-center">
            <div class="p-3 d-grid gap-2">
              <a href="#"  target="_blank" class="btn ripple btn-primary mt-0">View Demo</a>
              <a href="#" target="_blank"  class="btn ripple btn-success">Buy Now</a>
              <a href="#"  target="_blank" class="btn ripple btn-red">Our Portfolio</a>
            </div>
          </div>
