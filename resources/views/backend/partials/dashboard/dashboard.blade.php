                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-6">
                                <div class="">
                                    <span class="fs-14 font-weight-normal">Total Topics</span>
                ...
                <div class="card overflow-hidden dash1-card border-0 dash3">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-6">
                                <div class="">
                                    <span class="fs-14">Numbers</span>
                                    <h2 class="mb-2 mt-1 number-font carn2 font-weight-bold">$2,59</h2>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-6 my-auto mx-auto">
                                <div class="mx-auto text-right">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-6">
                                <div class="text-justify">
                                    ...
                                    <h2 class="mb-2 mt-1 number-font carn2 font-weight-bold">$1,95</h2>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-6 my-auto mx-auto">
                                <div class="mx-auto text-right">
                            ...
                            <table class="table table-hover card-table table-vcenter text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{ asset('superadmin/assets/images/orders/7.jpg') }}" alt="img">Books</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{ asset('superadmin/assets/images/orders/5.jpg') }}" alt="img">Sports</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{ asset('superadmin/assets/images/orders/6.jpg') }}" alt="img">Accesories</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{ asset('superadmin/assets/images/orders/4.jpg') }}" alt="img">Watches</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="avatat avatar-md brround me-2" src="{{ asset('superadmin/assets/images/orders/10.jpg') }}" alt="img">speakers</td>
