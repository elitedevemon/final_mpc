                ...
                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-plum-plate">
                            <div class="menu-header-image" style="background-image: url('{{ asset('backend/assets/images/dropdown-header/abstract4.jpg') }}');"></div>
                ...
                <div tabindex="-1" role="menu" aria-hidden="true"
                    ...
                    <div class="dropdown-menu-header mb-0">
                        <div class="dropdown-menu-header-inner bg-deep-blue">
                            <div class="menu-header-image opacity-1" style="background-image: url('{{ asset('backend/assets/images/dropdown-header/city3.jpg') }}');"></div>
                                                                ...
                                                                <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/1.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/2.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/3.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/4.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/5.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/9.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/7.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                        <div class="avatar-icon">
                                                                            <img src="{{ asset('backend/assets/images/avatars/8.jpg') }}" alt="">
                                                                        </div>
                                                                    </div>
                            ...
                            <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-info">
                                        <div class="menu-header-image opacity-2" style="background-image: url('{{ asset('backend/assets/images/dropdown-header/city3.jpg') }}');"></div>
                                            ...
                                            <div class="widget-content p-0">
                                                <div class="widget-content-wrapper">
                                                    ...
                                                    <div class="widget-content-right mr-2">
                                                        <a href="{{ route('logout') }}" class="btn-pill btn-shadow btn-shine btn btn-focus" onclick="confirm('Are you sure to logout?'); event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
