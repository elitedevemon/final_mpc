...
<head>
		...
		<!-- Title -->
		<title>MPC Method | Reset password</title>
	...
	<body class="h-100vh error-bg">
        ...
        @livewire('backend.auth.reset-password', ['username'=>$auth_username])
...
<!-- Mirrored from laravel.spruko.com/azea/ltr/reset-password3 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Nov 2021 01:18:52 GMT -->
</html>
