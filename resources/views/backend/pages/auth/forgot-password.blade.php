...
<head>
		...
		<!-- Title -->
		<title>MPC Method|Forgot Password</title>

        <!--Favicon -->
		<link rel="icon" href="{{ asset('logo/MPC.png') }}" type="image/x-icon"/>
	...
	<body class="h-100vh error-bg">
        ...
        @livewire('backend.auth.forgot-password', ['username'=>$auth_username])
...
<!-- Mirrored from laravel.spruko.com/azea/ltr/forgot-password2 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Nov 2021 01:18:52 GMT -->
</html>
