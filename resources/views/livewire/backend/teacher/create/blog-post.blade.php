  ...
  <div class="app-content main-content">
    <div class="side-app">
      ...
      <form wire:submit.prevent enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-9">
            <input type="text" name="title" placeholder="Enter title" class="form-control" value="{{ old('title') }}" wire:model='title'>
          </div>
          <div class="col-md-3">
            <input type="file" name="photo" class="form-control" value="{{ old('photo') }}" wire:model='photo'>
          </div>
        </div>
        <textarea name="short_desc" rows="2" class="form-control my-2" placeholder="Enter your short description" wire:model="shortDescription">{{ old('short_desc') }}</textarea>
        <div wire:ignore>
          <textarea name="blogText" wire:model='blogText' class="form-control">{{ old('blogText') }}</textarea>
        </div>
