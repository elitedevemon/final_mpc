      ...
      <div class="row mt-4">
        <div class="col-12">
          <div class="card">
            ...
            >
              <textarea class="form-control br-br-0 br-bl-0" placeholder="Type your question here...." rows="5" wire:model.debounce.1000ms="question"></textarea>
          ...
          <div class="card">
            ...
            @foreach ($all_questions as $question)
              <div class="card-body pb-0 mb-0">
                ...
                <div class="mt-4">
                  <a href="{{ route('view.teacher.selected.faq', ['faq_id'=>$question->id, 'language'=> app()->getLocale()]) }}">
                ...
                <div class="media mg-t-15 profile-footer">
                  ...
                  <div class="ms-auto">
                    ...
                    <a class="new {{ $check_comment?'bg-success text-light':'' }}" href="{{ route('view.teacher.selected.faq', ['faq_id'=>$question->id, 'language'=> app()->getLocale()]) }}"><i class="fe fe-message-square"></i></a>
