          ...
          <div class="col-xl-4 col-lg-6 col-md-12">
            <div class="card overflow-hidden">
              <div class="item7-card-img">
                <a href="{{ route('view.teacher.selected.post', ['slug'=> $post->slug, 'language'=>app()->getLocale()]) }}">
              ...
              <div class="card-body">
                <div class="item7-card-desc d-flex mb-5">
                  ...
                  <div class="ms-auto">
                    ...
                    @endphp
                    <!--end PHP code-->
                    <a class="me-0 d-flex" href="{{ route('view.teacher.selected.post', ['slug'=> $post->slug, 'language'=>app()->getLocale()]) }}"><i class="fe fe-message-square fs-16 me-1 p-3 bg-warning-transparent brround text-warning font-weight-bold border-warning"></i><span class="mt-3 ms-1 text-muted font-weight-semibold">{{ count($total_comments) }} Comments</span></a>
                  </div>
                </div>
                <a href="{{ route('view.teacher.selected.post', ['slug'=> $post->slug, 'language'=>app()->getLocale()]) }}" class="mt-4"><h5 class="font-weight-semibold text-primary">{{ Str::words($post->title, 7) }}</h5></a>
