<div>
  <div class="container py-4">
    ...
    <div class="row mb-3">
      <div class="col-5">
        <input type="text" placeholder="Enter Receiver Name" class="form-control @error('name') is-invalid @enderror" wire:model='name'>
      </div>
      <div class="col-6">
        <input type="email" placeholder="Enter Receiver Email" class="form-control @error('email') is-invalid @enderror" wire:model='email'>
      </div>
