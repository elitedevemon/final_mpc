                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center mb-4">
                                <h5 class="card-title me-2">Registration Info</h5>
                                <div class="ms-auto">
                                    <div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm">
                                    <div id="registration-info" data-colors='["#777aca", "#5156be", "#a8aada"]' class="apex-charts"></div>
                                </div>
                                <div class="col-sm align-self-center">
                                    <div class="mt-4 mt-sm-0">
                                        <div>
                                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-success"></i> All Users: {{ $registeredUsers[0] }}</p>
                                        </div>

                                        <div class="mt-4 pt-2">
                                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Teachers: {{ $registeredUsers[1] }}</p>
                                        </div>

                                        <div class="mt-4 pt-2">
                                            <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-info"></i> Students: {{  $registeredUsers[2] }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--Javascript section for charts-->
@push('js')
  <script>
    var piechartColors=getChartColorsArray("#registration-info"),options={series:@json($registeredUsers),chart:{width:227,height:227,type:"pie"},labels:["All","Student","Teacher"],colors:piechartColors,stroke:{width:0},legend:{show:!1},responsive:[{breakpoint:480,options:{chart:{width:200}}}]};(chart=new ApexCharts(document.querySelector("#registration-info"),options)).render();
  </script>
@endpush
