...
@livewire('frontend.pages.welcome.header')
   ...
   <div style="padding: 23px; font-family: tahoma;">
    ...
    <div style="font-size: 20px">
      ...
      <a href="mailto: muradprivatecenter@gmail.com" style="color: rgb(66,133,244); text-decoration: none; font-weight: bold">muradprivatecenter@gmail.com</a><br><br>
      <i>Last updated: 01/18/2022</i>
    </div>
  </div>
