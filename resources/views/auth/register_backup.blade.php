            ...
            <div class="row">
              <div class="col-6">
                <div class="form-check">
                  <input type="radio" name="get_role" id="get_teacher" class="form-check-input">
                  <label for="get_teacher" class="form-check-label">Teacher</label>
                </div>
              </div>
              <div class="col-6">
                <div class="form-check">
                  <input type="radio" name="get_role" id="get_student" class="form-check-input">
                  <label for="get_student" class="form-check-label">Student</label>
                </div>
              </div>
            </div>
